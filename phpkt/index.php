...
shuffle($images);
$slides = array_slice($images, 0, 3);
?>
<div id="carouselExampleControls" class="carousel slide mx-auto" data-ride="carousel" style="max-width: 800px;">
  <div class="carousel-inner">
    <?php foreach($slides as $i => $img): ?>
      <div class="carousel-item <?php echo $i === 0 ? 'active' : ''; ?>">
        <img class="d-block w-100" src="<?php echo $img; ?>" alt="Slide <?php echo $i+1; ?>">
      </div>
    <?php endforeach; ?>
  </div>
