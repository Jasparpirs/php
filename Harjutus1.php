...
<form action="#" method="get">
        hinne <input type="number" name="hinne" required value="5"  min="1" max="10"><br>
        <input type="submit" value="Leia Hinne">
    </form>
    <?php
...
?>
    ...
    <form action="#" method="get">
        ...
        <input type="submit" value="jaga" class="btn btn-danger">
